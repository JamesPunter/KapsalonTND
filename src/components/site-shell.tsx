...
function SiteHeader() {
  return (
    <header className="sticky top-0 z-40 border-b border-amber-950/10 bg-background/86 backdrop-blur-xl">
              ...
              <div className="mt-4 grid gap-2">
                <a
                  className={cn(
                    ...
                    "justify-start rounded-2xl border-stone-950/10 bg-white",
                  )}
                ...
                <a
                  className={cn(
                    ...
                    "justify-start rounded-2xl bg-stone-950 text-stone-50 hover:bg-stone-800",
                  )}
              ...
              return (
                <a
                  ...
                  className={cn(
                    ...
                    "rounded-full border border-white/10 bg-white/8 px-4 text-stone-100 hover:bg-white/14",
                  )}
                  href={link.href}
                  rel="noreferrer"
                  target="_blank"
...
function BrandLockup() {
  return (
    <Link className="flex items-center gap-3" to="/">
      <span className="flex size-12 shrink-0 overflow-hidden rounded-2xl border border-stone-950/10 bg-stone-950 shadow-[0_12px_30px_-16px_rgba(18,18,18,0.85)] sm:size-14">
        <img
